        ...
        <section className="py-20 bg-gray-50 bg-slate-900/10">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className='grid md:grid-cols-2 gap-8'>
                    <div className='bg-white p-8 rounded-3xl shadow-md hover:bg-blue-400'>
                        ...
                        <div className='w-40 h-40 rounded-full border-4 border-blue-500 p-[50px] animate-[spin_2s_linear_infinite] font-bold text-2xl'>MCS <br /> LLP</div>
                    </div>


                    <div className='md:col-span-1 bg-white p-8 rounded-3xl shadow-lg hover:bg-blue-200'>
